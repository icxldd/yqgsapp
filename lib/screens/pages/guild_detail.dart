...
class GuildDetail extends StatefulWidget {
  GuildDetail({Key key, @required this.guildId}) : super(key: key);
  final String guildId;
  @override
  _GuildDetailState createState() => _GuildDetailState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      background: Image.network(
          "http://oss.yangqungongshe.com/541f2e70-f54b-4a47-bc6f-f1766ec14d7c.jpg",
          fit: BoxFit.cover),
      title: Text(widget.guildId,
          style: TextStyle(
